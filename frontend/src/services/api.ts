...
import { Expense, Income, Summary, TransactionFormData, TransactionType } from '../types/transaction';
...
export class ApiService {
  ...
  static async addTransaction(type: TransactionType, data: TransactionFormData): Promise<Expense | Income> {
